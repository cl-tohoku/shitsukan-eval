...
class Llama2InstructHf:
    ...
    Example usage:
    >>> model = Llama2InstructHf(pretrained="meta-llama/Llama-2-7b-chat-hf", device_map={"": 0})
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initializes the Llama2InstructHf class by loading the model, processor, and tokenizer.
        ...
        Example:
        >>> model = Llama2InstructHf(pretrained="meta-llama/Llama-2-7b-chat-hf", device="cuda")
        """
        super().__init__()
    ...
    def create_system_prompt(system_prompt: str) -> list[dict[str, Any]]:
        ...
        Example:
        >>> prompt = Llama2InstructHf.create_system_prompt("You are a helpful assistant.")
    ...
    def create_zero_shot_prompt(zero_shot_data: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        >>> prompt = Llama2InstructHf.create_zero_shot_prompt(zero_shot)
        """
        role = "user"
    ...
    def create_few_shot_prompt(few_shot_data: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        >>> prompt = Llama2InstructHf.create_few_shot_prompt(few_shot)
        """
        messages = []
    ...
    def generate_response(
        ...
        Example usage:
        >>> model = Llama2InstructHf(pretrained="meta-llama/Llama-2-7b-chat-hf")
        ...
        if system_prompt:
            message += Llama2InstructHf.create_system_prompt(system_prompt)

        # Add few-shot examples if provided
        if few_shot_data:
            message += Llama2InstructHf.create_few_shot_prompt(few_shot_data)

        # Add the main user input (text and images)
        message += Llama2InstructHf.create_zero_shot_prompt({"user": text})
