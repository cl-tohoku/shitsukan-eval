...
class Llama3InstructHf:
    ...
    Example usage:
    >>> model = Llama3InstructHf(pretrained="meta-llama/Llama-3.1-8B-Instruct", device_map={"": 0})
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initializes the Llama3InstructHf class by loading the model, processor, and tokenizer.
        ...
        Example:
        >>> model = Llama3InstructHf(pretrained="meta-llama/Llama-3.1-8B-Instruct", device="cuda")
        """
        super().__init__()
    ...
    def create_system_prompt(system_prompt: str) -> list[dict[str, Any]]:
        ...
        Example:
        >>> prompt = Llama3InstructHf.create_system_prompt("You are a helpful assistant.")
    ...
    def create_zero_shot_prompt(zero_shot_data: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        >>> prompt = Llama3InstructHf.create_zero_shot_prompt(zero_shot)
        """
        role = "user"
    ...
    def create_few_shot_prompt(few_shot_data: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        >>> prompt = Llama3InstructHf.create_few_shot_prompt(few_shot)
        """
        messages = []
    ...
    def generate_response(
        ...
        Example usage:
        >>> model = Llama3InstructHf(pretrained="meta-llama/Llama-3.1-8B-Instruct")
        ...
        if system_prompt:
            message += Llama3InstructHf.create_system_prompt(system_prompt)

        # Add few-shot examples if provided
        if few_shot_data:
            message += Llama3InstructHf.create_few_shot_prompt(few_shot_data)

        # Add the main user input (text and images)
        message += Llama3InstructHf.create_zero_shot_prompt({"user": text})
